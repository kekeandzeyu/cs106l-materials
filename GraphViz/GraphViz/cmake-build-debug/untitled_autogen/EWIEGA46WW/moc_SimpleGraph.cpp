...
struct qt_meta_stringdata_CLASSSimpleGraphENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSSimpleGraphENDCLASS = QtMocHelpers::stringData(
    "SimpleGraph",
    "graphUpdated",
    "",
    "graph"
...
Q_CONSTINIT static const uint qt_meta_data_CLASSSimpleGraphENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject SimpleGraph::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSSimpleGraphENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSSimpleGraphENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSSimpleGraphENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<SimpleGraph, std::true_type>,
        // method 'graphUpdated'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<SimpleGraph, std::false_type>
    >,
    nullptr
} };
...
void SimpleGraph::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &SimpleGraph::graphUpdated; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *SimpleGraph::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSSimpleGraphENDCLASS.stringdata0))
